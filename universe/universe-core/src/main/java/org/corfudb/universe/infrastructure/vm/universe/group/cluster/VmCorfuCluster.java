 ...
 */
@Slf4j
public class VmCorfuCluster extends AbstractCorfuCluster<VmParams<CorfuServerParams>, VmCorfuServer> {
     ...
     */
    @Override
    protected VmCorfuServer buildServer(VmParams<CorfuServerParams> deploymentParams) {
