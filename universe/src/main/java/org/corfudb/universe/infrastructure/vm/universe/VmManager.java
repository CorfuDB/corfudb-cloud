...
import static org.corfudb.universe.infrastructure.vm.universe.ApplianceManager.ResourceType.DATA_STORE;
import static org.corfudb.universe.infrastructure.vm.universe.ApplianceManager.ResourceType.HOST_SYSTEM;
import static org.corfudb.universe.infrastructure.vm.universe.ApplianceManager.ResourceType.RESOURCE_TYPE;
...
public class VmManager {
    ...
    public IpAddress getIpAddress() {
        ...
        IpAddress ip = vmIpAddress.get();
        if (ip != null) {
            return ip;
        }

        return vmIpAddress.updateAndGet(prevIp -> {
            if (prevIp != null) {
                return prevIp;
            }
