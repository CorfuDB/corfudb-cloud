...
public class KillServiceOneHundredTimesInTwoNodesClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after kill service on two node in loop for 100 times
    ...
    private void verifyKillService(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOneHundredTimesInTwoNodesClusterTable";
