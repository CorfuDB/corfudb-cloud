...
public class RebootThreeNodesOneHundredTimesTest extends AbstractCorfuUniverseTest {
    ...
    @Test
    public void test() {
        testRunner.executeTest(this::verifyRebootThreeNodesOneHundredTimesTest);
    }

    private void verifyRebootThreeNodesOneHundredTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_RebootThreeNodesOneHundredTimesTable";
