...
public class RestartServiceFiveHundredTimesInTwoNodeClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after restart service on two nodes in loop for 500 times
    ...
    private void verifyRestartService(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceFiveHundredTimesInTwoNodeClusterTable";
