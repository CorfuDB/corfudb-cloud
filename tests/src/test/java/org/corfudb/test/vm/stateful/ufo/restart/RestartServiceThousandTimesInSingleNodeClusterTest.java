...
public class RestartServiceThousandTimesInSingleNodeClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after restart service on one node in loop for 1000 times
    ...
    private void verifyRestartService(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceThousandTimesInSingleNodeClusterTable";
