...
public class KillServiceOnTwoNodesOneHundredTimesParallelTest extends AbstractCorfuUniverseTest {
    ...
    @Test
    public void test() {
        testRunner.executeTest(this::verifyKillServiceOnTwoNodesOneHundredTimesParallelTest);
    }

    private void verifyKillServiceOnTwoNodesOneHundredTimesParallelTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnTwoNodesOneHundredTimesParallelTable";
