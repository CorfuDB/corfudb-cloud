...
public class KillServiceOnThreeNodesOneHundredTimesTest extends AbstractCorfuUniverseTest {
    ...
    @Test
    public void test() {
        testRunner.executeTest(this::verifyKillServiceOnThreeNodesOneHundredTimesTest);
    }
    ...
    private void verifyKillServiceOnThreeNodesOneHundredTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnThreeNodesOneHundredTimesTable";
