...
@Slf4j
public class PowerOffOnThreeNodesFiveHundredTimesTest extends AbstractCorfuUniverseTest {
     ...
     * 7)  Power Off, power ON and start corfu process on all three nodes one by one
