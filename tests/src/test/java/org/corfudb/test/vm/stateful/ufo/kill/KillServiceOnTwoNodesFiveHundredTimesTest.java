...
public class KillServiceOnTwoNodesFiveHundredTimesTest extends AbstractCorfuUniverseTest {
    ...
    @Test
    public void test() {
        testRunner.executeTest(this::verifyKillServiceOnTwoNodesFiveHundredTimesTest);
    }

    private void verifyKillServiceOnTwoNodesFiveHundredTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnTwoNodesFiveHundredTimesTable";
