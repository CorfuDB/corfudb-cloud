...
public class KillServiceOnThreeNodesOneThousandTimesParallelTest extends AbstractCorfuUniverseTest {
    ...
    @Test
    public void test() {
        testRunner.executeTest(this::verifyKillServiceOnThreeNodesOneThousandTimesParallelTest);
    }

    private void verifyKillServiceOnThreeNodesOneThousandTimesParallelTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnThreeNodesOneThousandTimesParallelTable";
