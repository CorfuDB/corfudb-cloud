...
public class KillServiceOnOneNodeOneHundredTimesTest extends AbstractCorfuUniverseTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyKillServiceOnOneNodeOneHundredTimesTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyKillServiceOnOneNodeOneHundredTimesTest(
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnOneNodeOneHundredTimesTable";
