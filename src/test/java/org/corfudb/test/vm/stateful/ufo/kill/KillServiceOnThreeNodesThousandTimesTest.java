...
public class KillServiceOnThreeNodesThousandTimesTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyKillServiceOnThreeNodesThousandTimesTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyKillServiceOnThreeNodesThousandTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnThreeNodesThousandTimesTable";
