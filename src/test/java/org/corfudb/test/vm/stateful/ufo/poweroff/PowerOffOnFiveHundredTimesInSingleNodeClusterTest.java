...
public class PowerOffOnFiveHundredTimesInSingleNodeClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after power off/power on node in loop for 500 times
     ...
     * 6) PowerOff/PowerOn node and then start corfu process on node
    ...
    private void verifyPowerOnPowerOffNode(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_PowerOffOnFiveHundredTimesInSingleNodeClusterTable";
