...
public class KillServiceOnTwoNodesThousandTimesParallelTest extends AbstractCorfuUniverseTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyKillServiceOnTwoNodesThousandTimesParallelTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyKillServiceOnTwoNodesThousandTimesParallelTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnTwoNodesThousandTimesParallelTable";
