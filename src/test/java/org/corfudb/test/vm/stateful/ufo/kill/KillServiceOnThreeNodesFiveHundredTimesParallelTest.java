...
public class KillServiceOnThreeNodesFiveHundredTimesParallelTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyKillServiceOnThreeNodesFiveHundredTimesParallelTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyKillServiceOnThreeNodesFiveHundredTimesParallelTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
