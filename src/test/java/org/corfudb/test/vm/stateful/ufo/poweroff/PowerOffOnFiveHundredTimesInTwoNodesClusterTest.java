...
public class PowerOffOnFiveHundredTimesInTwoNodesClusterTest {
     ...
     * <p>
     * Test cluster behavior after power off/power on two nodes in loop for 500 times
    ...
    private void verifyPowerOnPowerOffNode(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_PowerOffOnFiveHundredTimesInTwoNodesClusterTable";
