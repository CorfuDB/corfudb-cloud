...
public class KillServiceOnTwoNodesOneHundredTimesTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyKillServiceOnTwoNodesOneHundredTimesTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyKillServiceOnTwoNodesOneHundredTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceOnTwoNodesOneHundredTimesTable";
