...
public class RestartServiceOneHundredTimesInTwoNodeClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after restart service on two nodes in loop for 100 times
    ...
    private void verifyRestartService(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartCorfuOneHundredTimesInSingleNodeClusterTable";
        ...
        log.info("**** Detach node server2 from cluster ****");
        ...
        for (int loopCount = 1; loopCount <= LOOP_COUNT; loopCount++) {
            ...
            for (int serverIndex = 0; serverIndex <= 1; serverIndex++) {
        ...
        log.info("**** Add node server2 to the cluster ****");
