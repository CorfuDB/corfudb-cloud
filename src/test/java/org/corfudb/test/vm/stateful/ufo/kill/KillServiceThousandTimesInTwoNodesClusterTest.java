...
public class KillServiceThousandTimesInTwoNodesClusterTest {
     ...
     * <p>
     * Test cluster behavior after kill service on two node in loop for 1000 times
    ...
    private void verifyKillService(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceThousandTimesInTwoNodesClusterTable";
