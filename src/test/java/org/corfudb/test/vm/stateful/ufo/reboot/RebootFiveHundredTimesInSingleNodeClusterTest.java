...
public class RebootFiveHundredTimesInSingleNodeClusterTest extends AbstractCorfuUniverseTest {
    ...
    private void verifyRebootNode(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RebootFiveHundredTimesInSingleNodeClusterTable";
