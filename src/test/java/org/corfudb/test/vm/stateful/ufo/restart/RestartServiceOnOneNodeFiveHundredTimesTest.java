...
public class RestartServiceOnOneNodeFiveHundredTimesTest extends AbstractCorfuUniverseTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyRestartServiceOnOneNodeFiveHundredTimesTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyRestartServiceOnOneNodeFiveHundredTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceOnOneNodeFiveHundredTimesTable";
