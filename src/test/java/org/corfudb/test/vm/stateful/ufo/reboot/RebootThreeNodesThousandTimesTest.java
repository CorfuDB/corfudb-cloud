...
public class RebootThreeNodesThousandTimesTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.deploy();
            try {
                verifyRebootThreeNodesThousandTimesTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyRebootThreeNodesThousandTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_RebootThreeNodesThousandTimesTable";
