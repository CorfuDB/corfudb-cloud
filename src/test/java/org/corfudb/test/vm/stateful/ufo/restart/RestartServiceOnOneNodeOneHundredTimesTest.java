...
public class RestartServiceOnOneNodeOneHundredTimesTest extends AbstractCorfuUniverseTest {
    ...
    @Test
    public void test() {
        testRunner.executeTest(this::verifyRestartServiceOnOneNodeOneHundredTimesTest);
    }

    private void verifyRestartServiceOnOneNodeOneHundredTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceOnOneNodeOneHundredTimesTable";
