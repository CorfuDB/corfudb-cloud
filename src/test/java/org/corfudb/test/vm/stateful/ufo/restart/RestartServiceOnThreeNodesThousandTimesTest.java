...
public class RestartServiceOnThreeNodesThousandTimesTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after service restarted on all three nodes 1000 times
     ...
     * 6) Restart (stop/start) the "corfu" service on all cluster nodes 1000 times
    ...
    private void verifyRestartService(UniverseManager.UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceOnThreeNodesThousandTimesTable";
        ...
        // Loop for 1000 times restart service on all nodes serially
        for (int loopCount = 1; loopCount <= 1000; loopCount++) {
        ...
        log.info("**** Wait for cluster status STABLE :: after 1000 times restart ****");
        waitForClusterStatusStable(corfuClient);
