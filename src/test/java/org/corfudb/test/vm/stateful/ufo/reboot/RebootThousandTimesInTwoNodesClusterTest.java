...
public class RebootThousandTimesInTwoNodesClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after reboot two nodes in loop for 1000 times
     ...
     * 6) Reboot the nodes, and wait for 30sec before starting the 'corfu' process to start
    ...
    private void verifyRebootNode(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RebootThousandTimesInTwoNodesClusterTable";
