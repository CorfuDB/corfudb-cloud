...
public class RestartServiceOnOneNodeThousandTimesTest {
    ...
    public void test() {
        ...
        universeManager.workflow(wf -> {
            ...
            wf.initUniverse();
            try {
                verifyRestartServiceOnOneNodeThousandTimesTest(wf);
            } catch (Exception e) {
                fail("Failed", e);
            }
        });
    ...
    private void verifyRestartServiceOnOneNodeThousandTimesTest(UniverseWorkflow<Fixture<UniverseParams>> wf)
            throws Exception {
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceOnOneNodeThousandTimesTable";
