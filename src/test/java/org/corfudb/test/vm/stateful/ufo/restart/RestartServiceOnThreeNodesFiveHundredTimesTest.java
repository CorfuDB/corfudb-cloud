...
public class RestartServiceOnThreeNodesFiveHundredTimesTest {
     ...
     * <p>
     * Test cluster behavior after service restarted on all three nodes 500 times
     ...
     * 6) Restart (stop/start) the "corfu" service on all cluster nodes 500 times
    ...
    private void verifyRestartService(UniverseManager.UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_RestartServiceOnThreeNodesFiveHundredTimesTable";
        ...
        // Loop for 500 times restart service on all nodes serially
        ...
        log.info("**** Wait for cluster status STABLE :: after 500 times restart ****");
        waitForClusterStatusStable(corfuClient);
