...
public class KillServiceFiveHundredTimesInSingleNodeClusterTest extends AbstractCorfuUniverseTest {
     ...
     * <p>
     * Test cluster behavior after kill service on one node in loop for 500 times
    ...
    private void verifyKillService(UniverseWorkflow<Fixture<UniverseParams>> wf)
        ...
        // Define table name
        String tableName = "CorfuUFO_KillServiceFiveHundredTimesInSingleNodeClusterTable";
